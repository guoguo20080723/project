...
However, to calculate the co-occurence matrix, the amount of calculation is very large. In addition, the n-gram model depends significantly on the corpus and the results of the model will vary with the value n. It is hard to use the analysis to predict the probablity of word A following word B because any data is limited and it is likely to miss some perfectly acceptable word sequences.
...
Most of the words correlated with border is related to national security and defense or immigration fields. Some countries such as "Iran", "Mexico", and "Israel" are highly correlated with border.
